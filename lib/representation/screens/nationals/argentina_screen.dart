...
class ArgentinaScreen extends StatefulWidget {
  const ArgentinaScreen({super.key});

  static const String routeName = 'argentina_screen';

  @override
  State<ArgentinaScreen> createState() => _ArgentinaScreenState();
}
...
class _ArgentinaScreenState extends State<ArgentinaScreen> {
  ...
  final List<ItemModel> listRoom = [
    ItemModel(
      image: 'https://i.imgur.com/SNTI2ey.png',
      name: 'Logo',
      size: 40,
      price: 1,
    ),
    ItemModel(
      image: 'https://i.imgur.com/IC1Iito.png',
      name: 'Home Kit',
      size: 40,
      price: 2,
    ),
    ItemModel(
      image: 'https://i.imgur.com/pAqlnDk.png',
      name: 'Away Kit',
      size: 40,
      price: 3,
    ),
    ItemModel(
      image: 'https://i.imgur.com/YrcwVPY.png',
      name: 'Goalkeeper Home Kit',
      size: 40,
      price: 4,
    ),
    ItemModel(
      image: 'https://i.imgur.com/3ZZ3blT.png',
