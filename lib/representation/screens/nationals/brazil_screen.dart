...
class BrazilScreen extends StatefulWidget {
  ...
  static const String routeName = 'brazil_screen';

  @override
  State<BrazilScreen> createState() => BrazilScreenState();
}

class BrazilScreenState extends State<BrazilScreen> {
  BannerAd? _banner;
  @override
  void initState() {
    super.initState();
  ...
  final List<ItemModel> listRoom = [
    ...
    ItemModel(
      image: 'https://i.imgur.com/uHzkqMp.png',
      name: 'Home Kit',
      size: 40,
      price: 2,
    ),
    ItemModel(
      image: 'https://i.imgur.com/RtJwb1A.png',
      name: 'Away Kit',
      size: 40,
      price: 3,
    ),
    ItemModel(
      image: 'https://i.imgur.com/SruT1v7.png',
      name: 'Goalkeeper Home Kit',
      size: 40,
      price: 4,
    ),
    ItemModel(
      image: 'https://i.imgur.com/3N2ktOh.png',
      name: 'Goalkeeper Away Kit',
      size: 40,
      price: 5,
    ),
    ItemModel(
      image: 'https://i.imgur.com/CQEagVR.png',
