...
class ArsenalScreen extends StatefulWidget {
  ...
  static const String routeName = 'arselnal_screen';
...
class _ArsenalScreenState extends State<ArsenalScreen> {
  ...
  final List<ItemModel> listRoom = [
    ItemModel(
      image: 'https://i.imgur.com/m0REiTP.png',
      name: 'Logo',
      size: 40,
      price: 1,
    ),
    ItemModel(
      image: 'https://i.imgur.com/uvmlVDK.png',
      name: 'Home Kit',
      size: 40,
      price: 2,
    ),
    ItemModel(
      image: 'https://i.imgur.com/tUQ0emW.png',
      name: 'Away Kit',
      size: 40,
      price: 3,
    ),
    ...
    ItemModel(
      image: 'https://i.imgur.com/AeEAgf2.png',
      name: 'Goalkeeper Home Kit',
      size: 40,
      price: 4,
    ),
    ItemModel(
      image: 'https://i.imgur.com/p93KHrY.png',
      name: 'Goalkeeper Away Kit',
      size: 40,
      price: 5,
    ),
    ItemModel(
      image: 'https://i.imgur.com/KcrPJjP.png',
