...
class TottenhamlScreen extends StatefulWidget {
  const TottenhamlScreen({super.key});

  static const String routeName = 'totenham_screen';

  @override
  State<TottenhamlScreen> createState() => _TottenhamlScreenState();
}

class _TottenhamlScreenState extends State<TottenhamlScreen> {
  BannerAd? _banner;
  @override
  void initState() {
    super.initState();
  ...
  final List<ItemModel> listRoom = [
    ItemModel(
      image: 'https://i.imgur.com/V8Np2oV.png',
      name: 'Logo',
      size: 40,
      price: 1,
    ),
    ItemModel(
      image: 'https://i.imgur.com/eHvW94a.png',
      name: 'Home Kit',
      size: 40,
      price: 2,
    ),
    ItemModel(
      image: 'https://i.imgur.com/kqReLvP.png',
      name: 'Away Kit',
      size: 40,
      price: 3,
    ),
