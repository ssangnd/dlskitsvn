...
class ManchesterUnitedScreen extends StatefulWidget {
  const ManchesterUnitedScreen({super.key});

  static const String routeName = 'manu_screen';

  @override
  State<ManchesterUnitedScreen> createState() => _ManchesterUnitedScreenState();
}

class _ManchesterUnitedScreenState extends State<ManchesterUnitedScreen> {
  BannerAd? _banner;
  @override
  void initState() {
    super.initState();
  ...
  final List<ItemModel> listRoom = [
    ItemModel(
      image: 'https://i.imgur.com/gy7o8c3.png',
      name: 'Logo',
      size: 40,
      price: 1,
    ),
    ItemModel(
      image: 'https://i.imgur.com/kxbgdVI.png',
      name: 'Home Kit',
      size: 40,
      price: 2,
    ),
    ItemModel(
      image: 'https://i.imgur.com/LmtVdu0.png',
      name: 'Away Kit',
      size: 40,
      price: 3,
    ),
