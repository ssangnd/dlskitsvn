...
class EvertonScreen extends StatefulWidget {
  const EvertonScreen({super.key});

  static const String routeName = 'everton_screen';

  @override
  State<EvertonScreen> createState() => _EvertonScreenState();
}

class _EvertonScreenState extends State<EvertonScreen> {
  BannerAd? _banner;
  @override
  void initState() {
    super.initState();
  ...
  final List<ItemModel> listRoom = [
    ...
    ItemModel(
      image: 'https://i.imgur.com/aTPImxG.png',
      name: 'Home Kit',
      size: 40,
      price: 2,
    ),
    ItemModel(
      image: 'https://i.imgur.com/WSrvdsP.png',
      name: 'Away Kit',
      size: 40,
      price: 3,
    ),
