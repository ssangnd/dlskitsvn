...
class AcMilanScreen extends StatefulWidget {
  const AcMilanScreen({super.key});

  static const String routeName = 'acmilan_screen';

  @override
  State<AcMilanScreen> createState() => _AcMilanScreenState();
}

class _AcMilanScreenState extends State<AcMilanScreen> {
  BannerAd? _banner;
  @override
  void initState() {
    super.initState();
  ...
  final List<ItemModel> listRoom = [
    ItemModel(
      image: 'https://i.imgur.com/iw0pfTA.png',
      name: 'Logo',
      size: 40,
      price: 1,
    ),
    ItemModel(
      image: 'https://i.imgur.com/Wqljqzq.png',
      name: 'Home Kit',
      size: 40,
      price: 2,
    ),
    ItemModel(
      image: 'https://i.imgur.com/JtSE9Ux.png',
      name: 'Away Kit',
      size: 40,
      price: 3,
    ),
