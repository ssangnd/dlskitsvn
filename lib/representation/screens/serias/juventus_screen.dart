...
class JuventuslScreen extends StatefulWidget {
  const JuventuslScreen({super.key});

  static const String routeName = 'juventus_screen';

  @override
  State<JuventuslScreen> createState() => _JuventuslScreenState();
}

class _JuventuslScreenState extends State<JuventuslScreen> {
  BannerAd? _banner;
  @override
  void initState() {
    super.initState();
  ...
  final List<ItemModel> listRoom = [
    ItemModel(
      image: 'https://i.imgur.com/TTlk1j7.png',
      name: 'Logo',
      size: 40,
      price: 1,
    ),
    ItemModel(
      image: 'https://i.imgur.com/X9Jj6Br.png',
      name: 'Home Kit',
      size: 40,
      price: 2,
    ),
    ItemModel(
      image: 'https://i.imgur.com/cg3VVDm.png',
      name: 'Away Kit',
      size: 40,
      price: 3,
    ),
