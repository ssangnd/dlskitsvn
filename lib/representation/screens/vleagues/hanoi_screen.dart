...
class HaNoiScreen extends StatefulWidget {
  ...
  static const String routeName = 'hanoi_screen';
...
class _HaNoiScreenState extends State<HaNoiScreen> {
  ...
  final List<ItemModel> listRoom = [
    ItemModel(
      image: 'https://i.imgur.com/YR1jko7.png',
      name: 'Logo',
      size: 40,
      price: 1,
    ),
    ItemModel(
      image: 'https://i.imgur.com/QLLuxAZ.png',
      name: 'Home Kit',
      size: 40,
      price: 2,
    ),
    ItemModel(
      image: 'https://i.imgur.com/BlnBQlv.png',
      name: 'Home Kit (Yellow)',
      size: 40,
      price: 2,
    ),
    ItemModel(
      image: 'https://i.imgur.com/Pa0Cp1f.png',
      name: 'Away Kit',
      size: 40,
      price: 3,
    ),
    ItemModel(
      image: 'https://i.imgur.com/AytXmGF.png',
      name: 'Goalkeeper Home Kit',
      size: 40,
      price: 4,
    ),
    ItemModel(
      image: 'https://i.imgur.com/rQyTGIV.png',
