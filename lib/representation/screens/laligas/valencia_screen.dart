...
class ValenciaScreen extends StatefulWidget {
  const ValenciaScreen({super.key});

  static const String routeName = 'valencia_screen';

  @override
  State<ValenciaScreen> createState() => _ValenciaScreenState();
}

class _ValenciaScreenState extends State<ValenciaScreen> {
  BannerAd? _banner;
  @override
  void initState() {
    super.initState();
  ...
  final List<ItemModel> listRoom = [
    ItemModel(
      image: 'https://i.imgur.com/jGAKxl4.png',
      name: 'Logo',
      size: 40,
      price: 1,
    ),
    ItemModel(
      image: 'https://i.imgur.com/HJWQO0q.png',
      name: 'Home Kit',
      size: 40,
      price: 2,
    ),
    ItemModel(
      image: 'https://i.imgur.com/o0cMe3e.png',
      name: 'Away Kit',
      size: 40,
      price: 3,
    ),
